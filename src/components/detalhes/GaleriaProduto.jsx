...
const GaleriaProduto = ({ imagemPrincipal, titulo }) => {
  const [fotoExibida, setFotoExibida] = useState(imagemPrincipal);

  // Simulando outras fotos do produto (no futuro virá da sua API/Banco)
  const outrasFotos = [
    imagemPrincipal,
    ...
    <div className="flex-1 flex flex-col gap-6">
      ...
      <div className="relative aspect-square rounded-[40px] overflow-hidden border border-white/10 bg-[#0a0a1a] group shadow-2xl">
        <img 
          ...
          alt={titulo}
        />
        {/* Overlay de sombra suave embaixo da foto */}
